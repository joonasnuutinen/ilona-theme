...
function ilona_scripts() {
	...
	wp_enqueue_script( 'ilona-carousel', get_template_directory_uri() . '/js/carousel.js', array( 'jquery' ), null, true );

	wp_enqueue_script( 'ilona-circles', get_template_directory_uri() . '/js/circles.js', array( 'jquery' ), null, true );
